...
--
-- Servidor: localhost
-- Tempo de Geração: 17/01/2016 às 13:34
...
CREATE TABLE IF NOT EXISTS `conta` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_conta_forma_pagamento_idx` (`forma_pagamento_id`),
...
CREATE TABLE IF NOT EXISTS `endereco` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_endereco_pessoa_idx` (`pessoa_id`),
...
INSERT INTO `endereco` (`id`, `endereco`, `complemento`, `bairro`, `cep`, `pessoa_id`, `cidade_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'Eum pariatur Illum dolore earum cupiditate soluta hic', 'Quia quo aut maiores earum repudiandae laboris quaerat aut veniam tempora aliquam voluptas eos', 'Fuga Debitis dolores suscipit in odio tempor dolore aut repellendus Natus neque in fugit aspernatur ', 'Ut dolore', 1, 1357, 0, '2016-01-16 21:48:25', '2016-01-16 21:48:25'),
(2, 'Velit magni deserunt ut rem', 'Culpa dolor ea facilis culpa qui dolor temporibus a dolore asperiores ipsum', 'Dolores unde natus rerum ea', 'Voluptate', 2, 106, 0, '2016-01-16 21:48:57', '2016-01-16 21:48:57'),
(3, 'Totam ad voluptatibus autem eligendi vero', 'Accusantium consequuntur suscipit iusto iure ea deleniti consequat Sunt perferendis reprehenderit al', 'Qui dolores eum culpa inventore qui nostrud', 'Consequat', 3, 4404, 0, '2016-01-17 12:00:23', '2016-01-17 12:00:23'),
(4, 'Rerum quae facere tempora sed velit reprehenderit architecto officia similique possimus voluptas exp', 'Odio consectetur amet deleniti cupiditate et', 'Magni in quaerat tempora dolore excepturi modi dolores quaerat voluptatem In voluptas enim voluptas ', 'Quos dele', 4, 108, 0, '2016-01-17 12:03:09', '2016-01-17 12:03:09'),
(5, 'Aut neque non qui quos deserunt dolorum reprehenderit pariatur Eligendi quas mollit et nulla eius di', 'Vel saepe porro nisi libero possimus quia obcaecati laborum voluptas rerum', 'Eos modi culpa quia id quia sint facilis dolorem qui laborum non a', 'Magni qui', 5, 292, 0, '2016-01-17 12:03:25', '2016-01-17 12:03:25'),
(6, 'Dolore ad ut velit voluptatem et', 'Ut voluptatem officia omnis sequi non quo veniam commodi', 'Soluta ullam animi modi aut lorem ullamco sint soluta sint consectetur tempor irure quis optio moles', 'Ipsum qui', 6, 3200, 0, '2016-01-17 13:07:03', '2016-01-17 13:07:03'),
(7, 'Beatae quibusdam rerum rerum excepturi quas temporibus excepturi nulla voluptates omnis earum ducimu', 'Magni voluptatem ut dolores nostrud', 'Deserunt deserunt tempore nisi quis neque voluptatem Ad nemo est magnam consequuntur', 'Illo erro', 7, 2433, 0, '2016-01-17 12:04:42', '2016-01-17 12:04:42'),
(8, 'Ut Nam sunt esse aliquam mollitia eaque', 'Eum quos nisi unde fuga Eum impedit dolore dignissimos sunt cupidatat praesentium et in inventore ea', 'Illo in fuga Dolor ducimus placeat et facere ab', 'Laborum E', 8, 1291, 0, '2016-01-17 12:05:14', '2016-01-17 12:05:14'),
(9, 'Voluptas nisi cumque molestiae est aliquip facere fugiat ipsa', 'Delectus perferendis adipisicing expedita dolore', 'Placeat soluta ipsa ullam labore explicabo Sed sed labore alias occaecat a possimus excepteur dolor ', 'Non repre', 9, 290, 0, '2016-01-17 12:05:35', '2016-01-17 12:05:35'),
(10, 'Expedita lorem pariatur Sed fugiat repellendus Maxime provident id eos', 'Illum quo tempora voluptatem quia aute atque ipsam qui pariatur Ut nostrud mollit dolorem sunt eiusm', 'Magni numquam nihil ex velit vel dolorem sit eveniet', 'Totam har', 10, 3376, 0, '2016-01-17 12:06:10', '2016-01-17 12:06:10'),
(11, 'Fuga Unde sed pariatur Elit qui incidunt nulla ratione deleniti quis magni facere rerum deleniti ita', 'Ut quis laborum Dolorem corporis qui eveniet nisi est qui deserunt et consequatur reprehenderit et i', 'Deserunt ea ad quia irure quae nobis aperiam facilis et nostrud sed ea voluptatem dolore reiciendis ', 'Fugit dis', 11, 3190, 0, '2016-01-17 12:06:40', '2016-01-17 12:06:40'),
(12, 'rua', 'qd 13 lt 49', 'araguaia', '111111-11', 12, 898, 0, '2016-01-17 13:01:11', '2016-01-17 13:01:11'),
(13, 'Omnis enim dolores sequi voluptatem eligendi occaecat veniam et itaque rerum quo velit quidem sunt f', 'Saepe quam optio ad architecto ut deleniti velit dolore quaerat ex', 'Ex voluptates voluptatem doloremque magna qui non quas expedita molestiae dolorem ea', 'Autem pos', 13, 2786, 0, '2016-01-17 12:22:34', '2016-01-17 12:22:34'),
(14, 'Rua RA$', 'QD13', 'Sonho de ficar rico', '111111-11', 14, 9, 0, '2016-01-17 13:28:05', '2016-01-17 13:28:05');
...
CREATE TABLE IF NOT EXISTS `forma_pagamento` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Define a forma de pagamento: [Dinheiro, Cartao, Cheque, Boleto]' AUTO_INCREMENT=1 ;
...
INSERT INTO `pessoa` (`id`, `nome`, `email`, `telefone`, `celular`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'Consectetur debitis facilis facere suscipit tempor est ea tempore minus', 'qorarumib@gmail.com', '(11) 1111-1111', '(11) 1111-1111', 0, '2016-01-16 21:48:25', '2016-01-16 21:48:25'),
(2, 'Quisquam Nam ea explicabo Et quam quae magni ipsa magni enim illum porro ut incididunt occaecat quo ', 'lupomezi@gmail.com', '(11) 1111-1111', '(22) 2222-2222', 0, '2016-01-16 21:48:57', '2016-01-16 21:48:57'),
(3, 'Rem enim velit inventore explicabo Quia aut illo amet', 'syda@gmail.com', '(11) 1111-1111', '(11) 1111-1111', 0, '2016-01-17 12:00:23', '2016-01-17 12:00:23'),
(4, 'Optio reprehenderit quisquam voluptas facere aut error consequatur Qui quia cillum et voluptas nisi ', 'guvad@yahoo.com', '(11) 1111-1111', '(22) 2222-2222', 1, '2016-01-17 12:03:09', '2016-01-17 12:03:09'),
(5, 'Est quae eaque magnam nihil', 'zovodetizi@gmail.com', '(11) 1111-1111', '(33) 3333-3333', 0, '2016-01-17 12:03:25', '2016-01-17 12:03:25'),
(6, 'remque Nam recusandae Totam qu', 'qopevi@yahoo.com', '(44) 4444-4444', '(44) 4444-4444', 0, '2016-01-17 13:07:03', '2016-01-17 13:07:03'),
(7, 'Magni quos tempor aute sequi labore voluptatem ad proident aliquid', 'dufino@yahoo.com', '(99) 9999-9999', '(99) 0000-0000', 0, '2016-01-17 12:04:42', '2016-01-17 12:04:42'),
(8, 'Qui vel amet porro ut ut proident esse natus', 'bypa@yahoo.com', '(55) 5555-5555', '(77) 7777-7777', 0, '2016-01-17 12:05:14', '2016-01-17 12:05:14'),
(9, 'Iure ducimus ea quia consectetur culpa sit qui pariatur Proident', 'huzugyt@hotmail.com', '(12) 1212-1211', '(12) 2121-2112', 0, '2016-01-17 12:05:35', '2016-01-17 12:05:35'),
(10, 'Vitae ullam aut debitis voluptatem inventore id neque inventore in', 'zicafec@hotmail.com', '(11) 1111-1111', '(22) 2222-2222', 0, '2016-01-17 12:06:10', '2016-01-17 12:06:10'),
(11, 'Occaecat a in ex culpa vel maxime voluptate et animi ea', 'wutenezuv@yahoo.com', '(55) 5444-4444', '(44) 4444-4445', 0, '2016-01-17 12:06:40', '2016-01-17 12:06:40'),
(12, 'TESTE', 'TESTE@yahoo.com', '(11) 1111-4444', '(11) 1111-4444', 0, '2016-01-17 13:01:11', '2016-01-17 13:01:11'),
(13, 'Rerum unde pariatur Tempore corporis in quia', 'xofov@hotmail.com', '(22) 2222-2222', '(33) 3333-3333', 1, '2016-01-17 12:22:34', '2016-01-17 12:22:34'),
(14, 'Allan Gonçalves da Cruz', 'allangcruz@gmail.com', '(11) 1111-1222', '(11) 1111-1222', 0, '2016-01-17 13:28:05', '2016-01-17 13:28:05');
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `fk_estado` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `conta`
--
ALTER TABLE `conta`
  ADD CONSTRAINT `fk_conta_forma_pagamento` FOREIGN KEY (`forma_pagamento_id`) REFERENCES `forma_pagamento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
