...
<main class="container view-grid">
    ...
    <div>
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="#tab-conta-pagar" ria-controls="tab-conta-pagar" role="tab" data-toggle="tab">Conta a Pagar</a></li>
        <li><a href="#tab-conta-receber" ria-controls="tab-conta-receber" role="tab" data-toggle="tab">Conta a receber</a></li>
      </ul>

      <!-- Tab panes -->
      <div class="tab-content">
        <div class="tab-pane active" id="tab-conta-pagar">
            <br>
        ...
        <div class="tab-pane" id="tab-conta-receber">
            <br>
            <?php echo form_open('pessoa', ['id' => 'form_pessoa_consultar', 'class' => 'form-horizontal']);?>
                <div class="form-group">
                    <div class="col-md-2 col-xs-4">
...
<script src="<?php echo base_url();?>assets/js/conta.js"></script>
<!-- Fim Javascripts -->